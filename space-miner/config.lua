...
config.dustTargets = {
  ...
  ["Monazite Dust"]            = { asteroid="Aluminium-LanthLine", priority=1 },
  ...
  ["Nether Star Dust"]         = { asteroid="Gem Ores",            priority=2 },
...
--------------------------------------------------------------------------------
config.conditions = {
  { itemName="Antimony Dust",           amountToMaintain=qty("100m") },
  { itemName="Gallium Dust",            amountToMaintain=qty("100m") },
  { itemName="Ichorium Dust",           amountToMaintain=qty("1m")   },
  ...
  { itemName="Adamantium Dust",         amountToMaintain=qty("100m") },
  { itemName="Aluminium Dust",          amountToMaintain=qty("100m") },
  { itemName="Bauxite Dust",            amountToMaintain=qty("100m") },
  { itemName="Monazite Dust",           amountToMaintain=qty("100m") },
  { itemName="Cobalt Dust",             amountToMaintain=qty("100m") },
  { itemName="Chrome Dust",             amountToMaintain=qty("100m") },
  { itemName="Copper Dust",             amountToMaintain=qty("100m") },
  { itemName="Diamond",                 amountToMaintain=qty("100m") },
  { itemName="Nether Star",             amountToMaintain=qty("100m") },
  { itemName="Nether Star Dust",        amountToMaintain=qty("100m") },
  { itemName="Magnesium Dust",          amountToMaintain=qty("100m") },
  { itemName="Callisto Ice Dust",       amountToMaintain=qty("100m") },
  { itemName="Europium Dust",           amountToMaintain=qty("100m") },
  { itemName="Gadolinite-Y Dust",       amountToMaintain=qty("100m") },
  { itemName="Lutetium Dust",           amountToMaintain=qty("100m") },
  { itemName="Naquadah Dust",           amountToMaintain=qty("100m") },
  { itemName="Nickel Dust",             amountToMaintain=qty("100m") },
  { itemName="Salt",                    amountToMaintain=qty("100m") },
  { itemName="Niobium Dust",            amountToMaintain=qty("100m") },
